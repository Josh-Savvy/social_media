...
//   document.getElementById("errorAlert").classList.add("translate-y-20");

export const errorAlert = (error, showCloseButton) => (
  <>
    {error && (
      <div
...
export const successAlert = (success, showCloseButton) => (
  <>
    {success && (
      <div
      ...
      >
        <div role="alert" className="w-full relative">
          <div className="bg-green-300 border border-green-400 text-green-700 text-center uppercase text-lg font-bold rounded px-20 py-2 ">
